...
class SEWegingTests(SimpleTestCase):
    def test_vak_havo_4(self):
        ...
        vak.toetsen = [
            Toets(jaar=2019, klas=Leerjaren.havo_4, vak=vak, pct=40,),
        ]
    ...
    def test_vak_vwo_4(self):
        ...
        vak = Vak(naam="Scheikunde")
        vak.toetsen = [
            Toets(jaar=2019, klas=Leerjaren.vwo_4, vak=vak, pct=40,),
        ]
    ...
    def test_vak_havo_5(self):
        vak = Vak(naam="Scheikunde")
        vak.toetsen = [
            Toets(jaar=2019, klas=Leerjaren.havo_5, vak=vak, pct=0,),
        ]
